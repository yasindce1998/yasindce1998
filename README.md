...
|:--------|:------------|:------|:-----:|
| [**KubeDagger**](https://github.com/yasindce1998/KubeDagger) | eBPF offensive research tool — network discovery, process hiding, container breakouts | `Go` `eBPF` | ![Stars](https://img.shields.io/github/stars/yasindce1998/KubeDagger?style=flat-square&color=FFCB6B&labelColor=292D3E&label=) |
| [**Warmor**](https://github.com/yasindce1998/Warmor) | eBPF + WASM security enforcer for workload protection | `Go` `Rust` `WASM` | ![Stars](https://img.shields.io/github/stars/yasindce1998/Warmor?style=flat-square&color=FFCB6B&labelColor=292D3E&label=) |
| [**Barzakh**](https://github.com/yasindce1998/Barzakh) | UEFI bootkit simulation for defensive detection engineering | `C` `Rust` `Python` | ![Stars](https://img.shields.io/github/stars/yasindce1998/Barzakh?style=flat-square&color=FFCB6B&labelColor=292D3E&label=) |
| [**Aegis-Shadow**](https://github.com/yasindce1998/Aegis-Shadow) | Dual-module eBPF framework — offensive rootkit + defensive runtime auditing | `Rust` `eBPF` | ![Stars](https://img.shields.io/github/stars/yasindce1998/Aegis-Shadow?style=flat-square&color=FFCB6B&labelColor=292D3E&label=) |
| [**NeuronTrace**](https://github.com/yasindce1998/NeuronTrace) | Kernel-level behavioral containment for AI agents via eBPF/LSM | `Rust` `eBPF` | ![Stars](https://img.shields.io/github/stars/yasindce1998/NeuronTrace?style=flat-square&color=FFCB6B&labelColor=292D3E&label=) |
| [**RedHands**](https://github.com/yasindce1998/RedHands) | MCP server exposing offensive security tools to AI agents | `Go` `MCP` | ![Stars](https://img.shields.io/github/stars/yasindce1998/RedHands?style=flat-square&color=FFCB6B&labelColor=292D3E&label=) |
...
![Cilium](https://img.shields.io/badge/Cilium-292D3E?style=flat-square&logo=cilium&logoColor=C3E88D)
